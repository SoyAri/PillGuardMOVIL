...
export default function SettingsScreen({ navigation }) {
  ...
  const [isProtanopiaPreview, setIsProtanopiaPreview] = useState(false); // Controla la vista previa del efecto Protanopia
  ...
  const applySettings = async () => {
    ...
    setIsProtanopia(isProtanopiaPreview); // Aplica el efecto Protanopia en base a la preview
    // Navega a la pantalla Home pasando los parámetros de configuración seleccionados
    navigation.navigate('Home', {
      isDarkMode,
      isProtanopia: isProtanopiaPreview,
      isDeuteranopia,
      isTritanopia,
      isMonochromatic,
      isDaltonism,
  ...
  useEffect(() => {
    ...
    cargarTema(); // Ejecuta la función al montar el componente
  }, []);
  ...
  return (
    ...
    <ScrollView 
      style={[isProtanopiaPreview ? styles.protanopia : null, { flex: 1 }]} // Aplica efecto Protanopia y ocupa toda la pantalla
    ...
    >
      ...
      <View style={[styles.settingsContainer, pendingTheme === "claro" ? styles.Scrollviewcolor : styles.base]}>
        ...
        {/* Configuración: Protanopia (vista previa) */}
        <View style={styles.setting}>
          <Text style={[styles.settingText, pendingTheme === "claro" ? styles.textColorBlack : styles.textColorWhite]}>
            Protanopia
          </Text>
          <Switch
            onValueChange={(value) => {
              setIsProtanopiaPreview(value); // Actualiza la preview del efecto Protanopia
            }}
            value={isProtanopiaPreview}
          />
        </View>
        ...
        <View style={styles.setting}>
          ...
          <Switch
            onValueChange={toggleSwitch(setIsDeuteranopia)} // Usa toggleSwitch para actualizar el estado
        ...
        <View style={styles.setting}>
          ...
          <Switch
            onValueChange={toggleSwitch(setIsTritanopia)} // Actualiza estado para Tritanopia
            value={isTritanopia}
          />
        </View>
        ...
        <View style={styles.setting}>
          ...
          <Switch
            onValueChange={toggleSwitch(setIsMonochromatic)} // Selecciona vista monocromática
        ...
        <View style={styles.setting}>
          ...
          <Switch
            onValueChange={toggleSwitch(setIsDaltonism)} // Actualiza activación de daltonismo
            value={isDaltonism}
          />
        </View>
